...
- **A-005**: The inquiry response for a no-bill VA echoes the amount the customer entered at the payment channel; it does not assert a bill amount, since no bill exists.
